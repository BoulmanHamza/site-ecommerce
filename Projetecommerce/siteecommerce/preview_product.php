...
?>
          ...
          <div class="col-md-6">
            ...
            <a href="sign.php"><button type="button" class="btn btn-light btn-md mr-1 mb-2 waves-effect waves-light"><i class="fa fa-shopping-cart pr-2"></i>Ajouter au panie</button></a>
          </div>
        </div>
